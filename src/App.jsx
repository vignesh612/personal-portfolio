    ...
    <div className="max-w-6xl mx-auto p-10 lg:p-20 grid lg:grid-cols-2 gap-16 items-center">
      <div className="space-y-6">
        ...
        <p className="text-xl text-gray-700">
          I explore the intersection of AI, quantum chemistry, and materials discovery.
          My research focuses on accelerating functional material prediction and design
          using machine learning and high‑performance simulations.
        </p>
        <Link
          to="/research"
